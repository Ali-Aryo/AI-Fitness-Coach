...
export default function ProfilePage() {
  ...
  const achievements = [
    { name: "First Workout", description: "Completed your first workout", icon: "star" as const, earned: true },
    { name: "Week Warrior", description: "Worked out 7 days in a row", icon: "trophy" as const, earned: true },
    { name: "Strength Master", description: "Complete 50 strength workouts", icon: "barbell" as const, earned: false },
  ];
